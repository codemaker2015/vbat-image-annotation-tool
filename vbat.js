...
(() => {
    ...
    const drawIntro = (context) => {
        ...
        context.fillText("FOR MORE:", zoomX(20), zoomY(550))
        context.fillText("Mail Us: Codemaker2015@gmail.com", zoomX(20), zoomY(600))
        context.fillText("Copyright @ 2021 Codemaker", zoomX(20), zoomY(700))
    }
